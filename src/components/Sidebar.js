...
const Sidebar = () => {
  ...
  return (
    <>
        <div className=' bg-gradient-to-b from-blue-500 to-blue-500 rounded-[20px] fixed lg:flex flex-col  hidden overflow-hidden'>
            ...
            <div className='flex flex-col px-[50px] justify-center text-white'>
                <div className='flex flex-row gap-[20px] pb-[30px] text-lg font-bold items-center'>
                    <img className="w-[18px] h-[18px]" src={dashboard_icon} alt="dash_icon" />
                    <Link to="/">Dashboard</Link>
                </div>

                <div className='flex flex-row gap-[20px] pb-[30px] text-lg font-normal items-center'>
            ...
            <div className='text-white px-[50px] text-lg py-[30px]  '>
